...
开机自启动 ✅
CCP和PWM同时开的影响,以及频率测试范围和定时器溢出的解决✅

ua电流档位  ,LIM_RST拉高然后延时✅

level shift出不到1800,确定1800出不到 ✅
...
5.0电阻二极管测试数据对比4.0报告✅
显示任务卡死,打印任务状态
超神的5.0板子PWM没有,查一查,可能卡死在哪了✅

260514
1.![alt text](日志pics/image.png)
用python模拟GTB上位机回读IC寄存器, python函数,gtb_read_reg(0xaa,32)✅

260518
1.ESP32-s3 USB收发64字节已完成✅
2.TCP与服务器通信✅
3.合并1,2
4.测量频率代码实现✅
