...
烧录程序后,按一下sw2即可开始报点
 ![alt text](pics/GTB/read_reg.png)

### 4. attention

4.1. 增大 底板参数USBD_HID0_EP_INT_OUT_BINTERVAL,
如改为 10,可以稳定program
4.2. 修改SPI分频 84M/256 ,烧录和报点比较稳定
...
.
![alt text](pics/GTB/gc40固件版本.png)
...
![alt text](pics/GTB/image-17.png)
